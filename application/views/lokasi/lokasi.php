        ...
        <div class="col-xs-12">
          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Lokasi Organisasi</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="box-body table-responsive no-padding">
              <p align="left">
                <a href="<?php echo base_url(); ?>lokasi/tambah" class="btn btn-primary"><i class="glyphicon glyphicon-plus glyphicon-white"></i> Tambah</a>
                <!--<a align="right" href="<?php echo base_url(); ?>lokasi/export/" class="btn btn-primary"><i class="fa fa-table"></i> Excel</a>--></p>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo $no;?></td>
                        <td>
                          <a href="<?php echo base_url();?>lokasi/detail_data/<?php echo $l['id_organisasi']; ?>" ><?php echo $l['nama_organisasi']; ?></td>
                        <td><?php echo $l['nama_pemimpin'];?></td>
                        <td><?php echo $l['jenis_organisasi'];?></td>
          ...
          <!-- /.modal-dialog -->
                        ...
                        <td>
                          <a href="<?php echo base_url(); ?>lokasi/detail_data/<?php echo $l['id_organisasi']; ?>" title="detail">
                          <button class="btn btn-xs btn-info"><i class="ace-icon fa fa-eye bigger-120"></i></button>
                          </a>                            
